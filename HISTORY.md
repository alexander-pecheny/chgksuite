...
- Добавлен HTML/Playwright пайплайн для раздаток (подкоманды create_html, html2img)
- Подкоманды раздаток переименованы для ясности (generate → 4s2hndt, run → hndt2pdf)
...
- Исправлено: `&` не декодировался в выходных файлах парсера docx
- Исправлена нумерация списков в источниках
- Расширение файла раздаток изменено на `.hndt`
- Добавлена страница документации по раздаткам
