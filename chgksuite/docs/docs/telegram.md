...
!!! warning
    ...
    Для первого выкладывания используйте [небольшой тестовый файлик](https://code.pecheny.me/pecheny/chgksuite/raw/branch/main/tests/smalltest.4s?ref_type=heads) (необязательно выкладывать в публичный канал, можно в приватный). После этого подождите пару дней, и тогда уже выкладывайте пакет. По идее такие действия должны «успокоить» антиспам, и вы сможете избежать неприятных сюрпризов.
