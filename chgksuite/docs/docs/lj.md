...
Откройте **4s-файл**, который у вас получился после [парсинга](../4s). Обратите внимание, что в формате 4s есть два поля «заголовок»: длинный заголовок `###` с формальным названием турнира — он будет включён в вордовский экспорт — и короткий для ЖЖ `###LJ`, так как длинный заголовок в постах ЖЖ неуместен. Парсер поле `###LJ` не создаёт — добавьте его вручную; без него будет использован обычный заголовок `###`.
